...
static void on_user_selected(GtkListBox *listbox, GtkListBoxRow *row, gpointer user_data1)
{
   	UserData *data1 = (UserData *)user_data1;
...
void list_show(int client_socket){
    ...
    //printf("list_show_client_socket:%d",client_socket);
    // 初始化GTK
    gtk_init(NULL,NULL);
